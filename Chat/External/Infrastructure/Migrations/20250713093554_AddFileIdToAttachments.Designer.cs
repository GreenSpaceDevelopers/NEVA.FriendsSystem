...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250713093554_AddFileIdToAttachments")]
    partial class AddFileIdToAttachments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommentAttachments", b =>
                {
                    ...
                    b.HasKey("CommentsId", "AttachmentsId");
            ...
            modelBuilder.Entity("MessageAttachments", b =>
                {
                    ...
                    b.HasKey("MessagesId", "AttachmentsId");
            ...
            modelBuilder.Entity("PostAttachments", b =>
                {
                    ...
                    b.HasKey("PostsId", "AttachmentsId");
            ...
            modelBuilder.Entity("CommentAttachments", b =>
                {
                    b.HasOne("Domain.Models.Messaging.Attachment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Messaging.Chat", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Messaging.Attachment", "ChatPicture")
                        .WithMany()
            ...
            modelBuilder.Entity("PostAttachments", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Blog.Post", null)
                        .WithMany()
